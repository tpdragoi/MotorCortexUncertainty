%% F2F_spikeRate.m
%  Session-normalized mean spike rate across units, Delayed Reward Task.
...
%% STUDY: R14 (reward on lick 1 and 4)
% Session list and group maps VERBATIM from tongue_r14.m / jaw_r14.m: 35
% sessions, three regions. cfg.trialCond selects which reward condition is
% plotted -- 8 is R1, 9 is R4.
spec.name = 'R1R4';
spec.sessionDates = { ...
...
spec.groupColours = [0.05 0.20 0.60 ; 0.35 0.70 0.90 ; 0.45 0.45 0.45];
...
spec.condSets = struct('name', {'R1','R4'}, 'condIdx', {8, 9}, ...
                       'colour', {[0.05 0.20 0.60], [0.35 0.70 0.90]});

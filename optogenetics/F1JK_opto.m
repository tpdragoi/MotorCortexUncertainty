...
PLOT.probLicks      = 2:6;   % contacts shown in fig 3 (and its BH family)
% [R1] was 2:12; the BH family is now these 5 contacts
...
date = '2023-10-31';
meta4 = struct('anm','TD4f','date',date);
date = '2023-11-02';
meta5 = struct('anm','TD4f','date',date);

date = '2023-10-27';
meta6 = struct('anm','TD5f','date',date);
date = '2023-10-29';
...
date = '2023-11-11';
meta12 = struct('anm','TD5f','date',date);
date = '2023-11-12';
meta13 = struct('anm','TD5f','date',date);

date = '2023-11-27';
meta14 = struct('anm','TD6f','date',date);
date = '2023-11-28';
meta15 = struct('anm','TD6f','date',date);
date = '2023-11-29';
meta16 = struct('anm','TD6f','date',date);

%% FS4B_decodeJaw.m
%  Ridge decoder of jaw position from population spike rates, Simple Reward Task.
...
% old repeat loop: for kkkk = 1:1  -> now RUN.nRepeats at the top
...
cfg.fitWindowMode     = 'contact1';   % EARLY model = Fig. S4B (was 'lick2ToBoutEnd'). Options: 'contact1' | 'bout' | 'lick2ToBoutEnd'
cfg.winBoutStartPad_s = 0.02;   % opens this long after contact 2 / cycle 2 closing
cfg.winBoutEndPad_s   = 0.20;   % Methods: 0.2 s after the last contact
...
spec.figRef       = 'Fig. S4B';   % the manuscript panel this file produces
...
spec.summaryFile  = fullfile(tempdir, 'decodeSummary_jaw_r1_clean.mat');

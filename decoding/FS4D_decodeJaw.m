...
cfg.fitWindowMode     = 'contact1';   % EARLY model = Fig. S4D (was 'contact1'). Options: 'contact1' | 'bout' | 'lick2ToBoutEnd'
...
spec.summaryFile  = fullfile(tempdir, 'decodeSummary_jaw_r14_clean.mat');

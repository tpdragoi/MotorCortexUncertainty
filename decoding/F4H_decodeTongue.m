%% F4H_decodeTongue.m
%  Ridge decoder of tongue length from population spike rates, VTA Reward Task.
...
% old repeat loop: for kkk = 1:5  -> now RUN.nRepeats at the top
...
cfg.fitWindowMode     = 'contact1';   % EARLY model = Fig. 4H (was 'contact1'). Options: 'contact1' | 'bout' | 'lick2ToBoutEnd'
...
spec.figRef       = 'Fig. 4H';   % the manuscript panel this file produces
...
spec.summaryFile  = fullfile(tempdir, 'decodeSummary_tongue_vta_clean.mat');

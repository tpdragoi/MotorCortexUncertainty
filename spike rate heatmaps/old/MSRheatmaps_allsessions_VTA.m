...
params.condition(end+1) = {'hit==1 & trialTypes == 2'};    % left to right         % right hits, no stim, aw off
params.condition(end+1) = {'hit==1 & trialTypes == 3'};    % left to right         % right hits, no stim, aw off
...
% % TD5f R1
date = '2025-02-15';
meta2 = loadTDv1_neur22(meta2,datapth,date);
% date = '2025-02-17';
% meta3 = loadTDv1_neur(meta3,datapth,date);
% date = '2025-02-18';
% meta4 = loadTDv1_neur(meta4,datapth,date);
% date = '2025-02-19';
% meta5 = loadTDv1_neur(meta5,datapth,date);

% % TD1d R1
% date = '2025-02-25';
% meta6 = loadTDv4_neur(meta6,datapth,date);
% date = '2025-02-26';
% meta7 = loadTDv4_neur(meta7,datapth,date);
date = '2025-02-27';
meta8 = loadTDv4_neur(meta8,datapth,date);
% date = '2025-02-28';
% meta9 = loadTDv4_neur(meta9,datapth,date);


% % TD1d R1
% date = '2025-08-21';
% meta10 = loadTDv6_neur(meta10,datapth,date);
% date = '2025-08-22';
% meta11 = loadTDv6_neur(meta11,datapth,date);
% date = '2025-08-23';
% meta12 = loadTDv6_neur(meta12,datapth,date);
% date = '2025-08-24';
% meta13 = loadTDv6_neur(meta13,datapth,date);
% date = '2025-08-25';
% meta14 = loadTDv6_neur(meta14,datapth,date);
% date = '2025-08-26';
% meta15 = loadTDv6_neur(meta15,datapth,date);


% date = '2025-08-25';
% meta16 = loadTDv5_neur(meta16,datapth,date);
% date = '2025-08-26';
% meta17 = loadTDv5_neur(meta17,datapth,date);
% date = '2025-08-28';
% meta18 = loadTDv5_neur(meta18,datapth,date);
% date = '2025-08-30';
% meta19 = loadTDv5_neur(meta19,datapth,date);
% date = '2025-08-31';
% meta20 = loadTDv5_neur(meta20,datapth,date);
...
p_all   = prctile(allData, [0.5 99.5]);

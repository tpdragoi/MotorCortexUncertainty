...
%%%%%%%% R1 %%%%%%%%%
Kinematics1 = kin.dat(:,condtrix,kinix);
Kinematics1 = Kinematics1(:,[ params.trialid{1, 8}]);
...
% cmp = [0 0 0; cmp];  % prepend black (RGB [0 0 0])
...
set(gcf, 'Position', [50 100 800 400]);  % [left bottom width height] in pixels

%% F5C_rateHeatmap.m
%  Per-session spike-rate heatmaps, Simple Reward Task, first five days of training.
...
date = '2025-08-21';
meta1 = slimMeta('loadTD5l_neur', date);
date = '2025-08-22';
meta2 = slimMeta('loadTD5l_neur', date);
date = '2025-08-23';
meta3 = slimMeta('loadTD5l_neur', date);
date = '2025-08-24';
meta4 = slimMeta('loadTD5l_neur', date);
date = '2025-08-25';
meta5 = slimMeta('loadTD5l_neur', date);

date = '2025-06-03';
meta6 = slimMeta('loadTD4l_neur', date);
date = '2025-06-04';
meta7 = slimMeta('loadTD4l_neur', date);
date = '2025-06-05';
meta8 = slimMeta('loadTD4l_neur', date);
date = '2025-06-06';
meta9 = slimMeta('loadTD4l_neur', date);
date = '2025-06-07';
meta10 = slimMeta('loadTD4l_neur', date);

% TD15d R1
date = '2025-02-03';
meta11 = slimMeta('loadTD2l_neur', date);
date = '2025-02-04';
meta12 = slimMeta('loadTD2l_neur219', date);
date = '2025-02-05';
meta13 = slimMeta('loadTD2l_neur', date);
date = '2025-02-06';
meta14 = slimMeta('loadTD2l_neur', date);
date = '2025-02-07';
meta15 = slimMeta('loadTD2l_neur', date);
% TD8d R1

date = '2025-02-03';
meta16 = slimMeta('loadTD3l_neur', date);
date = '2025-02-04';
meta17 = slimMeta('loadTD3l_neur', date);
date = '2025-02-05';
meta18 = slimMeta('loadTD3l_neur', date);
date = '2025-02-06';
meta19 = slimMeta('loadTD3l_neur', date);
date = '2025-02-07';
meta20 = slimMeta('loadTD3l_neur', date);
...
% ---- Combine & per-trial baseline subtract [-1, 0) s ----
    ...
    posMax = prctile(dataZero(isfinite(dataZero)), 99);
    if isempty(posMax) || ~isfinite(posMax) || posMax <= 0, posMax = 1; end   % caxis needs a finite, increasing range

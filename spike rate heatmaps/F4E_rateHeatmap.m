%% F4E_rateHeatmap.m
%  Per-session spike-rate heatmaps, VTA Reward Task.
...
% size these to THIS session/probe: without it they keep the previous
% iteration's length and sort_idx then indexes past the trials of this one.
